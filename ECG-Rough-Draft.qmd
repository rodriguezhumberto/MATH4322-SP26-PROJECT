...
# Importance plot of last run
varImpPlot(ecg.rf, n.var = 20, main = "Top 20 Most Influential Variables")
...
print(paste("Stability (Standard Deviation):", round(sd.accuracy.rf, 4)))
print(confusion.rf)
```